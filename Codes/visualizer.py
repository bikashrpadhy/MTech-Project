...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions):
        ...
        """thing_colors (list[tuple(r, g, b)]): Pre-defined color (in [0, 255]) for each thing category. Used for visualization.
           If not given, random colors will be used."""
        # TODO: define the colors properly
    ...
    def draw_sem_seg(self, sem_seg, area_threshold=None, alpha=0.8):
        ...
        Returns:
            output (VisImage): image object with visualizations.
        """
        """ In recognition, sometimes we use the term "thing" for instance-level tasks, and "stuff" for semantic segmentation tasks. """
        ...
        for label in labels:    
            ...
            text = _COLORS[len(_COLORS)-label+1]
        ...
        if annos:
            ...
            if self._instance_mode == ColorMode.SEGMENTATION:
                colors = [
                    ...
                    self._jitter(_COLORS[c]) for c in labels
                ]
